...
const schema = z.object({
  ...
  ADK_RUNTIME_ENABLED: z.string().default('false').transform((value) => value === 'true'),
  ADK_RUNTIME_FALLBACK_ENABLED: z.string().default('true').transform((value) => value === 'true'),
  ADK_PILOT_AGENTS: z.string().default('MIGUEL,LOLA'),
  ADK_MAX_LATENCY_MS: z.coerce.number().int().positive().default(20_000),
  ADK_INPUT_COST_PER_MILLION: z.coerce.number().nonnegative().default(0),
  ADK_OUTPUT_COST_PER_MILLION: z.coerce.number().nonnegative().default(0),
